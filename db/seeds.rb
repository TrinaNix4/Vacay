...
u1.groups.create(name: 'group1', image:'', location:'pool')
u1.groups.create(name: 'group2', image:'', location:'bar')
u2.groups.create(name: 'group1', image:'', location:'pool')
u2.groups.create(name: 'group2', image:'', location:'bar')
u3.groups.create(name: 'group1', image:'', location:'pool')
u3.groups.create(name: 'group3', image:'', location:'room 343')
u4.groups.create(name: 'group2', image:'', location:'bar')
u4.groups.create(name: 'group3', image:'', location:'room 343')
u5.groups.create(name: 'group2', image:'', location:'bar')
u5.groups.create(name: 'group4', image:'', location:'room 138')